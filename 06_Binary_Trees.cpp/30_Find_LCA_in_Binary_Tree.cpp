// Solved by me.
// In this we are first looking for any of the n1 and n2 and then returning the same value furter.
// if at any node the n1 and n2 reach from its left and right then this will be the required node for our ans.

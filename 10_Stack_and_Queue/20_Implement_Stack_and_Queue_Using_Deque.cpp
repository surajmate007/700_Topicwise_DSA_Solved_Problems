// Deque also known as double eneded queue, as name suggests is a special kind of queue in which insertions and deletions can be done at the
// last as well as at the beginning.
// A link-list representation of deque is such that each node points to the next node as well as the previous node. So that insertion and deletions
// take constant time at both the beginning and the last.
